...
func TestValidateBlockHeader(t *testing.T) {
	...
	testCases := []struct {
		...
		{"EncryptedRandom nil", func(block *types.Block) { block.EncryptedRandom = nil }},
		{"EncryptedRandom short", func(block *types.Block) {
			if block.EncryptedRandom != nil {
				block.EncryptedRandom.Random = block.EncryptedRandom.Random[:16]
			}
		}},
	}
