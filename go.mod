...
replace (
	...
	github.com/cometbft/cometbft => ./third_party/tendermint
	// Cosmos SDK checkout supplied outside this tree. x/distribution ConsensusVersion stays 4.
	github.com/cosmos/cosmos-sdk => ./third_party/cosmos-sdk
	github.com/cosmos/iavl => github.com/scrtlabs/iavl v1.2.2-secret.0
	github.com/scrtlabs/tm-secret-enclave => ./third_party/tm-secret-enclave
